            ...
            <div class="col-4">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputCiudad" placeholder="Ingresar nombre ciudad">
                    </div>
                    <div class="form-group">
                        <label for="inputPais">Pais</label>
                        <input type="text" class="form-control" id="inputPais" placeholder="Ingresar pais">
                    </div>
                    <div class="form-group">
                        <label for="inputHabitantes">Cantidad habitantes</label>
                        <input type="number" class="form-control" id="inputHabitantes" placeholder="Ingresar cantidad habitantes">
                    </div>
                    <div class="form-group">
                        <label for="inputSuperficie">Superficie</label>
                        <input type="number" step="0.01" class="form-control" id="inputSuperficie" placeholder="Ingresar superficie">
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="inputMetro">
